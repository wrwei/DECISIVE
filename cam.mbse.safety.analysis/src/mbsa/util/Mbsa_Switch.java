...
public class Mbsa_Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Mbsa_Package.MBSA_PACKAGE: {
				...
				if (result == null) result = caseModelElement(mbsaPackage);
				if (result == null) result = caseBaseElement(mbsaPackage);
				if (result == null) result = caseElement(mbsaPackage);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MBSA Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MBSA Package</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMBSAPackage(MBSAPackage object) {
		return null;
	}
