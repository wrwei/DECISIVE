...
/**
 * This is the item provider adapter for a {@link component.DirectedRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectedRelationshipItemProvider extends ComponentRelationshipItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_Package.Literals.DIRECTED_RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_Package.Literals.DIRECTED_RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((DirectedRelationship)object).getGid();
