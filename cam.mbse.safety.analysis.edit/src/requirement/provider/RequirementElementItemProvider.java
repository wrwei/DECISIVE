 ...
 * @generated
 */
public class RequirementElementItemProvider extends ArtifactElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RequirementElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RequirementElement)object).getGid();
		return label == null || label.length() == 0 ?
			getString("_UI_RequirementElement_type") :
			getString("_UI_RequirementElement_type") + " " + label;
	}
